...
**Multiple glossaries:** A `GLOSSARY-MAP.md` at the repo root lists the glossaries, where they live, and how they relate to each other:
...
- If `GLOSSARY-MAP.md` exists, read it to find the glossaries
